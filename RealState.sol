...
contract RealState {
   ...
   event ReviewLiked(uint256 indexed productId, uint256 indexed reviewIndex,address indexed liker, uint256 likes);
    ...
    function listProperty(address owner,uint256 price, string memory _propertyTitle,string memory _category,string memory _images,
    string memory _propertyAddress, string memory _description) external returns (uint256){
        ...
        property.descripton=_description;
    ...
    function getProperty(uint256 id)external view returns(uint256, address,uint256,string memory,string memory,string memory,string memory,
        string memory){
    ...
    //Reviews Function
     ...
     function getUserReviews(address user) external view returns(Review[] memory){
        ...
        Review[] memory userProductReviews =  new  Review[](totalReview);
